...
export function IndicatorBar({ rates = [], lastUpdated }: IndicatorBarProps) {
  return (
    <div className="h-[32px] relative shrink-0 w-full sticky top-0 z-20 bg-[#f4f4f7]">
      <div className="flex flex-row items-center justify-end size-full">
        <div className="content-stretch flex items-center gap-[24px] justify-end px-[32px] relative size-full">
          ...
          <button className="relative shrink-0 flex items-center justify-center text-[#6c7b8e] hover:text-[#18202a] transition-colors">
            <Bell size={14} />
          </button>
